...
public class FareAdapter extends RecyclerView.Adapter<FareAdapter.MyViewHolder> {
    ...
    public FareAdapter(Context applicationContext, List<Datum> doctor) {
    ...
    @NonNull
    @Override
    public FareAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_fare, parent, false);
        FareAdapter.MyViewHolder h = new FareAdapter.MyViewHolder(v);
        return h;
    }

    @Override
    public void onBindViewHolder(@NonNull FareAdapter.MyViewHolder holder, int position) {
        final Datum c = doctor.get(position);
        holder.tname.setText("\tMovie Name: " + c.getMname());
        holder.scap.setText("\tTicket Price : " + c.getPrice());
        ...
        holder.cprice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (sp.getString("utype", "").equals("admin")||sp.getString("utype", "").equals("theater")) {
                    ...
                    alertbox.setMessage("Do you want to Delete this Pricing details? ");
                    ...
                    alertbox.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Call<getMessage> call = apiService.login("deleteprice", c.getPid());
                            call.enqueue(new Callback<getMessage>() {
                                ...
                                public void onResponse(Call<getMessage> call, Response<getMessage> response) {
                                    if (response.body().getStatus().equals("success")) {
                                        ...
                                        Intent i = new Intent(context, ViewFare.class);
