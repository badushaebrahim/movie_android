...
public class getShows extends AppCompatActivity {
    RecyclerView doctorrc;
    List<Datum> doctor;
    ShowAdapter doctorAdapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_get_shows);
    ...
    private void searchemployee() {
        final ProgressDialog progressDoalog = new ProgressDialog(getShows.this);
        ...
        Call<getMessage> call = apiinterface.getshow("allshows",
        ...
        call.enqueue(new Callback<getMessage>() {
            ...
            public void onResponse(Call<getMessage> call, Response<getMessage> response) {
                ...
                if (response.body().getMessage().equals("success")) {
                    ...
                    doctorAdapter = new ShowAdapter(getApplicationContext(), doctor);
    ...
    public void onBackPressed() {
        startActivity(new Intent(getApplicationContext(), getTheaters.class));
        finish();
    }
}