...
public class getTheaters extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_theaters);
    ...
    private void searchemployee() {
        final ProgressDialog progressDoalog = new ProgressDialog(getTheaters.this);
        ...
        Call<getMessage> call = apiinterface.getmymovie("alltheaters1",ss.getString("eid",""));
