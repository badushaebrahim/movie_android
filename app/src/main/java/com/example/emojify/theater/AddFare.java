...
public class AddFare extends AppCompatActivity {
    Spinner th, movie;
    EditText time;
    Button btnadd;
    String mval="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mval.equals("")) {
                    Toast.makeText(AddFare.this, "please select a movie", Toast.LENGTH_SHORT).show();
                } else if (time.getText().toString().isEmpty()) {
                    time.setError("Enter show time");
                } else {
                    SharedPreferences sp = getSharedPreferences("login", Context.MODE_PRIVATE);
                    final ProgressDialog progressDoalog = new ProgressDialog(AddFare.this);
                    ...
                    Call<getMessage> call = apiInterface.addshow("addfare",
                    ...
                    call.enqueue(new Callback<getMessage>() {
                        ...
                        public void onResponse(Call<getMessage> call, Response<getMessage> response) {
                            ...
                            if (response.body().getMessage().equals("success")) {
                                Toast.makeText(AddFare.this, "Time Added Successfully", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(AddFare.this, AddFare.class));
                                finish();
                            } else {
                                Toast.makeText(AddFare.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void getspinner1() {
        ...
        call.enqueue(new Callback<getMessage>() {
            ...
            public void onResponse(Call<getMessage> call, Response<getMessage> response) {
                ...
                if (response.body().getMessage().equals("success")) {
                    ...
                    try {
                        ...
                        ArrayAdapter aa = new ArrayAdapter(AddFare.this, android.R.layout.simple_list_item_1, movies);
                        aa.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                        //Setting the ArrayAdapter data on the Spinner
                        movie.setAdapter(aa);
                    } catch (Exception e) {
                        Toast.makeText(AddFare.this, e+"", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(AddFare.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<getMessage> call, Throwable t) {
                progressDoalog.dismiss();
                Toast.makeText(AddFare.this, t + "", Toast.LENGTH_SHORT).show();
            }
        });
    }
