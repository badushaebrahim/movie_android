...
import com.example.emojify.Adapter.ShowAdapter1;
...
public class ViewShowTime extends AppCompatActivity {
    ...
    List<Datum> doctor;
    ShowAdapter1 doctorAdapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_show_time);
    ...
    private void searchemployee() {
        final ProgressDialog progressDoalog = new ProgressDialog(ViewShowTime.this);
        ...
        Call<getMessage> call = apiinterface.getmymovie("gettime",sp.getString("uid",""));
        ...
        call.enqueue(new Callback<getMessage>() {
            ...
            public void onResponse(Call<getMessage> call, Response<getMessage> response) {
                ...
                if (response.body().getMessage().equals("success")) {
                    ...
                    doctorAdapter = new ShowAdapter1(getApplicationContext(), doctor);
