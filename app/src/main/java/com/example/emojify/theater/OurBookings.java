...
public class OurBookings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_our_bookings);
    ...
    private void searchemployee() {
        final ProgressDialog progressDoalog = new ProgressDialog(OurBookings.this);
        ...
        Call<getMessage> call = apiinterface.getmymovie("getmybook1",
                ss.getString("uid",""));
